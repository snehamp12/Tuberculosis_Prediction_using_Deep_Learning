...
plt.grid(True)
plt.tight_layout()
plt.savefig("resnet16_accuracy_curve.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("resnet16_loss_curve.png")
plt.show()
...
plt.tight_layout()
plt.savefig("resnet16_confusion_matrix.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("resnet16_roc_curve.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("resnet16_precision_recall_curve.png")
plt.show()
...
plt.tight_layout()
plt.savefig("resnet16_classwise_accuracy.png")
plt.show()
